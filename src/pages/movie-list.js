        ...
        >
          ...
          <div class="movie-details">
            ...
            <div class="movie-meta">
              ...
              ${
                movie.release_year
                  ? ` &middot; ${escapeHtml(movie.release_year)}`
                  : ""
              }
            </div>
          </div>
  ...
  return renderLayout(
    ...
    <main class="container">
      <header class="movies-header">
        <div>
          <div class="brand">
            PG <span>Streaming</span>
          </div>

          <h1>Cat&aacute;logo de pel&iacute;culas</h1>

          <p>
            Eleg&iacute; una pel&iacute;cula y comenz&aacute; a verla.
          </p>
        </div>
      ...
      ${
        movies.length
          ...
          : `
            <div class="message">
              Todav&iacute;a no hay pel&iacute;culas disponibles.
            </div>
          `
      }
    </main>
